                ...
                <el-card>
                    <Detail title="总销售额" count="￥123456">
                        <template slot="charts">
                            <span>周同比&nbsp;&nbsp;56.67% &nbsp;<svg t="1664177487018" class="icon"
                                    viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg" p-id="3651"
                                    width="16" height="16">
                                    <path
                                    ...
                                    <path
                                        ...
                                        fill="#E8D4AB" p-id="3655"></path>
                                    <path d="M384.1536 444.142933h1.5872l-20.48 409.6h268.2368l-20.48-409.6"
                                        fill="#D5382E" p-id="3656"></path>
                                    <path
                                    ...
                                    <path
                                        ...
                                        fill="#E8D4AB" p-id="3661"></path>
                                </svg></span>
                            &nbsp;&nbsp;
                            <span>日同比&nbsp;&nbsp;19.67% &nbsp;<svg t="1664177800755" class="icon"
                                    viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg" p-id="5024"
                                    width="16" height="16">
                                    <path
                                        d="M252.484267 566.749867h11.776v16.6912h-11.776zM815.684267 566.8352h10.461866v16.9984h-10.461866z"
                                        fill="#996E28" p-id="5025"></path>
                                    <path
                                    ...
                                    <path
                                        ...
                                        fill="#E8D4AB" p-id="5028"></path>
                                    <path d="M654.523733 591.854933h-1.5872l20.48-409.6H405.1968l20.48 409.6"
                                        fill="#AF3131" p-id="5029"></path>
                                    <path d="M654.523733 593.5616h-1.5872l20.48-409.6H405.1968l20.48 409.6"
                                        fill="#D5382E" p-id="5030"></path>
                                    <path
...
import lineCharts from './lineChart/index.vue'
import barCharts from './barChart/index.vue'
